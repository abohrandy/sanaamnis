    ...
    <PolicyPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            "Email info@sanaamniscoconut.com or communitymartlimited@gmail.com with your order number and, where relevant, a photograph of the problem. You do not need to ship anything back before hearing from us.",
