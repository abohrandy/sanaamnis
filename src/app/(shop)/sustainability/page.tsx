    ...
    <PolicyPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            "We do not yet hold organic certification, and we do not claim it. Our coconuts are grown without synthetic pesticide programmes, but certification is a formal process we have not completed.",
