...
export default async function AdminLayout({
  ...
  return (
    <ToastProvider>
      <div className="flex min-h-screen bg-background text-foreground font-sans overflow-hidden selection:bg-[#C9A227] selection:text-[#161A17]">
        <Sidebar userProfile={profile} />

        <main className="flex-1 h-screen overflow-y-auto bg-background p-8 md:p-12">
