...
export const DELIVERY_ZONES: DeliveryZone[] = [
  ...
  zone("Abuja", undefined, "Life Camp", 3000),
  zone("Abuja", undefined, "Kafe", 2500),
  zone("Abuja", undefined, "Mabushi", 3000),
  zone("Abuja", undefined, "Kado", 2700),
  zone("Abuja", undefined, "Jahi", 3000),
  zone("Abuja", undefined, "Banex", 3000),
  zone("Abuja", undefined, "Wuse 1", 3000),
  zone("Abuja", undefined, "Wuse 2", 3000),
  zone("Abuja", undefined, "Wuse Zone 3", 3000),
  zone("Abuja", undefined, "Wuse Zone 4", 3000),
  zone("Abuja", undefined, "Wuse Zone 5", 3000),
  zone("Abuja", undefined, "Wuse Zone 6", 3000),
  zone("Abuja", undefined, "Wuse Zone 7", 3000),
  zone("Abuja", undefined, "Gwarinpa 1st–3rd", 3000),
  zone("Abuja", undefined, "Gwarinpa 4th–7th Avenues", 3000),
  zone("Abuja", undefined, "Katampe", 3000),
  zone("Abuja", undefined, "Katampe Extension", 3000),
  ...
  zone("Abuja", undefined, "Idu Railway Station", 4000),
  zone("Abuja", undefined, "Asokoro", 4000),
  zone("Abuja", undefined, "Aya", 4000),
  zone("Abuja", undefined, "Kubwa", 4500),
  zone("Abuja", undefined, "Kubwa 2/1", 5000),
  zone("Abuja", undefined, "Kubwa 2/2", 5000),
  zone("Abuja", undefined, "Kubwa 2/3", 5000),
  zone("Abuja", undefined, "Kubwa 2/4", 5000),
  zone("Abuja", undefined, "Arab Road, Kubwa", 5500),
  zone("Abuja", undefined, "Dutse Baupma", 5500),
  ...
  zone("Abuja", "Areas Covered by Apo Distributor", "Dogongada Village", 2500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Efab Estate, Lokogoma", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Lokogoma", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Sarah Estate / Lokogoma Axis", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Sunnyvale Estate", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Wumba", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Suncity Estate", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Galadimawa", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Kabusa", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Dutse-Apo", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Apo Resettlement", 2500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Apo", 2500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Apo Legislative Quarters", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Gaduwa", 2500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Kaura", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Games Village", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Prince & Princess Estate", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Gudu", 2500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Durumi", 2500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Guzape", 3500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Garki Area 1", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Garki Area 2", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Garki Area 3", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Garki Area 7", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Garki Area 8", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Garki Area 10", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Garki Area 11", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "National Hospital Axis", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "City Gate", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Pyakasa", 3000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Chika", 3500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Trademore Estate", 3500),
  zone("Abuja", "Areas Covered by Apo Distributor", "Lugbe", 4000),
  zone("Abuja", "Areas Covered by Apo Distributor", "Lugbe Federal Housing", 4000),
  zone("Abuja", "Areas Covered by Apo Distributor", "River Park Estate", 5000),
